...
var calculator = function calculator(size, material, options, promo, price) {
  ...
  function calcFunc() {
    var sum = 0;
    Object(_services_request__WEBPACK_IMPORTED_MODULE_1__["getResurs"])("./assets/db.json").then(function (res) {
...
var drop = function drop() {
  ...
  ["dragenter", "dragleave", "dragover", "drop"].forEach(function (eventsDrag) {
  ...
  upload.forEach(function (input) {
    ["change", "drop"].forEach(function (events) {
      input.addEventListener(events, function (e) {
        ...
        input.previousElementSibling.textContent = uploadStr[0].length > 6 ? "".concat(uploadStr[0].slice(0, 6), "...").concat(uploadStr[1]) : uploadStr.join(".");
        ...
        if (!input.closest("form")) {
          ...
          Object(_services_request__WEBPACK_IMPORTED_MODULE_9__["postData"])("assets/design.php", formData).then(function (elem) {
            console.log(elem);
...
var modal = function modal() {
  ...
  function bindModal(triggerOpen, modal, triggerClose) {
    var destruction = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    ...
    function showWindow() {
      ...
      body.style.cssText = "\n            overflow: hidden;\n            margin-right: ".concat(getWidthScrollBar(), "px;\n        ");
  ...
  function openByScroll(selector) {
    window.addEventListener("scroll", function () {
      if (!checkOpenModal) {
        var heightTotalWindow = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight) - 2,
...
var sendForms = function sendForms() {
  ...
  upload.forEach(function (item) {
    item.addEventListener("input", function () {
      ...
      item.previousElementSibling.textContent = uploadStr[0].length > 6 ? "".concat(uploadStr[0].slice(0, 6), "...").concat(uploadStr[1]) : uploadStr.join(".");
    });
  });
  forms.forEach(function (el) {
    el.addEventListener("submit", function (e) {
      ...
      Object(_services_request__WEBPACK_IMPORTED_MODULE_9__["postData"])(url, formData).then(function (res) {
        console.log(res);
...
var showMoreImg = function showMoreImg(trigger, container) {
  ...
  btn.addEventListener("click", function () {
    ...
    Object(_services_request__WEBPACK_IMPORTED_MODULE_3__["getResurs"])("assets/db.json1").then(function (res) {
      if (_this.nextElementSibling != null && _this.nextElementSibling.matches(".alert-error")) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getResurs", function() { return getResurs; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
