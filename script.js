...
document.addEventListener("DOMContentLoaded", function () {
  ...
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])(".button-consultation", ".popup-consultation", ".popup-close", 3000);
});
...
var modal = function modal(triggerOpen, _modal, triggerClose) {
  var modalTimer = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
  var openBtn = document.querySelectorAll(triggerOpen),
      modalWindow = document.querySelector(_modal),
  ...
  modalWindow.addEventListener("click", function (e) {
    if (e.target && e.target.matches(triggerClose) || e.target.matches(_modal)) {
      hiddenModal();
    }
  });
};
